...
def compare_folders(folder1, folder2):
    """Compare two folders recursively with a progress bar."""
    print("\n🔍 Scanning folders...\n")
    ...
    # Save results to Excel in the **original format**
...
def save_to_excel(folder1, folder2, only_in_folder1, only_in_folder2, different_files, identical_files):
    """Save comparison results to an Excel file (keeping previous layout)."""
